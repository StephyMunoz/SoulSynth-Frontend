  ...
  return (
    <div className={classes.background}>
      ...
      <div className={classes.sectionBody}>
        <Typography variant="h6">
          <p>
            If you are reading this then it means you successfully linked your
            Spotify account and are logged in, nice!
          </p>
        </Typography>
        <Typography variant="h6">
          <p>
            Please use the buttons on the top of the page to start listening to music
            that fits your mood or to listen to one of the awesome playlists you have 
            created!
          </p>
        </Typography>
      </div>
